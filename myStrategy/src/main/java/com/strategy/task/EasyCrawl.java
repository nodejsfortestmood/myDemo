package com.strategy.task;

import com.strategy.core.agent.WebAgent;
import com.strategy.helper.http.UrlHelper;
...
public class EasyCrawl<R> {
    ...
    public void writeJsonToTxtWithBuffer(String filePath, String jsonContent) {
    ...
    public List<R> executePage(Map<String, Object> map, String pageIndexKey, String totalKey, Integer pageSize) {
        ...
        writeJsonToTxtWithBuffer("c:/temp/abc.txt",json.toString());
